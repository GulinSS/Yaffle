...
fuzzySearch expr = do
 ...
 where
  ...
  doFindAlt ns (DelayCase fc t a tm) = doFind ns tm
  doFindAlt ns (ConstCase fc c tm) = doFind ns tm
  doFindAlt ns (DefaultCase fc tm) = doFind ns tm
